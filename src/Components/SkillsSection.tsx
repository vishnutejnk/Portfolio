                        ...
                        <div key={index} className="grid grid-cols-[15%_85%] gap-6 mb-12">
                            ...
                            <div className="overflow-hidden">
                                ...
                                >
                                    ...
                                    {[...skillsByCategory.skills, ...skillsByCategory.skills, ...skillsByCategory.skills, ...skillsByCategory.skills, ...skillsByCategory.skills]
                                    .map((skill, skillIndex) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-col md:flex-row md:items-center items-center mb-2">
                                                <span className="text-sm text-foreground mb-1 md:mb-0 md:mr-2">{skill.level}%</span>
