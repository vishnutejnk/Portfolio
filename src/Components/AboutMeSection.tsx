            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        <h3 className="text-2xl font-semibold"> Passionate Web Developer and Software Engineer</h3>
                        <p>
                            With over 3 years of experience in full stack software development, I specialize 
